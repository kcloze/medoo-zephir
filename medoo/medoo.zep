...
class Medoo
{
    ...
    protected function dataImplode(data, conjunctor, outer_conjunctor = null) -> array
    {
        var wheres, key, relation_match, value, type, column, operator, like_clauses, item, suffix, tempArray;
